            ...
            {submitted ? (
              <div className="card text-center py-16">
                <div
                  ...
                  style={{ animation: "pop-in 0.5s ease-out forwards" }}
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6" aria-describedby={error ? "form-error" : undefined}>
                ...
                {error && (
                  <div id="form-error" role="alert" className="bg-red-50 border border-red-200 text-red-700 rounded-lg p-4 text-sm">
                    {error}
                  </div>
                )}
