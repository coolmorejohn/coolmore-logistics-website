      ...
      <section className="relative bg-brand-navy text-white min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
            ...
            <span className="text-brand-accent">Delivered Together.</span>
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              <div key={service.title} className="card text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-brand-accent/10 text-brand-accent mb-6">
                  {service.icon}
                </div>
