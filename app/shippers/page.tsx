...
export const metadata: Metadata = {
  title: "Shippers",
  description:
    "Focus on your business while Coolmore Logistics handles your freight. Dedicated logistics professionals, EDI integration, and real-time tracking.",
};
...
export default function ShippersPage() {
  return (
    <>
      <PageHero
        title="Shippers"
        subtitle="We understand that we are successful when you are able to focus on your business instead of logistics."
      />
